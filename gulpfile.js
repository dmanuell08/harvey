...
gulp.task('Watch', function(){
	...
	gulp.watch('dev/styl/*.styl', ['StylusToCSS']);
	...
	gulp.watch('dist/**/*.php', ['Sitemap']);
});

gulp.task('default', ['StylusToCSS','MovePhp','CompressCSS','CompressJS','CompressHTML','imageMin','Sitemap','Watch','Server']);